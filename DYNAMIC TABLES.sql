...
-- VERIFY TABLES
-- 1. BASE CORE TABLES
SELECT * FROM HOSPITAL_DW.MART.DIM_PATIENT;
SELECT * FROM HOSPITAL_DW.MART.DIM_DOCTOR;
SELECT * FROM HOSPITAL_DW.MART.FACT_APPOINTMENT;
SELECT * FROM HOSPITAL_DW.MART.FACT_BILLING;

-- 2. DASHBOARD VISUAL TABLES
SELECT * FROM HOSPITAL_DW.MART.DT_VISUAL_DEPT_APPT;
SELECT * FROM HOSPITAL_DW.MART.DT_VISUAL_PAYMENT_REVENUE;
SELECT * FROM HOSPITAL_DW.MART.DT_VISUAL_MONTHLY_REVENUE;
SELECT * FROM HOSPITAL_DW.MART.DT_VISUAL_DEMOGRAPHICS;
SELECT * FROM HOSPITAL_DW.MART.DT_VISUAL_APPT_STATUS;
SELECT * FROM HOSPITAL_DW.MART.DT_VISUAL_TOP_DOCTORS;
